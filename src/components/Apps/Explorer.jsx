...
const Explorer = () => {
  ...
  const handleSearch = async () => {
    const options = {
      ...
      headers: {
        "x-rapidapi-key": "b37719f4afmshb9ab4b56c86c077p150f84jsn9adfd48e399c", //i dont want to set up vercel after tyring for like 50 years to get githubapges to work
  ...
  return (
    <div className="ie">
      ...
      <section className="ie-address-bar"></section>
      ...
      <footer className="ie-footer"></footer>
    </div>
  );
};
