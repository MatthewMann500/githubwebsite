  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/meokjlyg", {
        //i dont want to set up vercel after tyring for like 50 years to get githubapges to work
        method: "POST",
        body: formData,
        headers: {
  ...
  return (
    <div className="mail-container">
      <div className="mail-toolbar">
        ...
        <button type="submit" form="mail-form" disabled={sending}>
          Send
        </button>
        <button type="button" onClick={handleClear} disabled={sending}>
          Clear
      ...
      <form id="mail-form" className="mail-form" onSubmit={handleSubmit}>
